...
COMMENT
	...
	date: Wed Mar 10 12:55:07 2021
ENDCOMMENT
NEURON {
	SUFFIX Viswan_2018_opt
	RANGE EGF_level, EGF_start, EGF_length, EGF_steepness
	RANGE pERK1_2_ratio1, pERK1_2_ratio2 : output
	RANGE PKC_active, APC, Inositol, PC, PIP2, EGF, Ca : assigned
...
PARAMETER {
	...
	EGF_length = 10000e3
	EGF_steepness = 1e-3
	kf_R1 = 0.000599998 (liter/micromole-millisecond): a kinetic parameter
	kr_R1 = 0.0005 (/millisecond): a kinetic parameter
	kf_R2 = 7.99985e-06 (liter/micromole-millisecond): a kinetic parameter
	kr_R2 = 0.0086348 (/millisecond): a kinetic parameter
	kf_R3 = 0.0012705 (/millisecond): a kinetic parameter
	kr_R3 = 0.0035026 (/millisecond): a kinetic parameter
	kf_R4 = 0.001 (/millisecond): a kinetic parameter
	kr_R4 = 0.0001 (/millisecond): a kinetic parameter
	kf_R5 = 1.20001e-06 (liter/micromole-millisecond): a kinetic parameter
	kr_R5 = 0.0001 (/millisecond): a kinetic parameter
	kf_R6 = 0.002 (/millisecond): a kinetic parameter
	kr_R6 = 0.0002 (/millisecond): a kinetic parameter
	kf_R7 = 0.001 (/millisecond): a kinetic parameter
	kr_R7 = 0.05 (/millisecond): a kinetic parameter
	kf_R8 = 1.20001e-07 (liter/micromole-millisecond): a kinetic parameter
	kr_R8 = 0.0001 (/millisecond): a kinetic parameter
	kf_R9 = 5.99998e-07 (liter/micromole-millisecond): a kinetic parameter
	kr_R9 = 0.0001 (/millisecond): a kinetic parameter
	kf_R10 = 1.79998e-05 (liter/micromole-millisecond): a kinetic parameter
	kr_R10 = 0.002 (/millisecond): a kinetic parameter
	kf_R11 = 0.000999997 (liter/micromole-millisecond): a kinetic parameter
	kr_R11 = 0.0001 (/millisecond): a kinetic parameter
	kf_R12 = 2.99999e-06 (liter/micromole-millisecond): a kinetic parameter
	kr_R12 = 0.004 (/millisecond): a kinetic parameter
	kf_R13 = 0.0004 (/millisecond): a kinetic parameter
	kf_R14 = 0.00599998 (liter/micromole-millisecond): a kinetic parameter
	kr_R14 = 0.0001 (/millisecond): a kinetic parameter
	kf_R15 = 0.00017 (/millisecond): a kinetic parameter
	kf_R16 = 0.00299999 (liter/micromole-millisecond): a kinetic parameter
	kr_R16 = 0.001 (/millisecond): a kinetic parameter
	kf_R17 = 0.0025 (/millisecond): a kinetic parameter
	kf_R18 = 0.00015 (/millisecond): a kinetic parameter
	kf_R19 = 0.0299999 (liter/micromole-millisecond): a kinetic parameter
	kr_R19 = 0.001 (/millisecond): a kinetic parameter
	kf_R20 = 0.0924103 (liter/micromole-millisecond): a kinetic parameter
	kr_R20 = 0.00497236 (/millisecond): a kinetic parameter
	kf_R21 = 0.000100916 (/millisecond): a kinetic parameter
	kf_R22 = 7.75638e-07 (/millisecond): a kinetic parameter
	kf_R23 = 0.000106208 (/millisecond): a kinetic parameter
	kf_R24 = 0.001 (/millisecond): a kinetic parameter
	kf_R25 = 0.0042 (liter/micromole-millisecond): a kinetic parameter
	kr_R25 = 0.00025 (/millisecond): a kinetic parameter
	kf_R26 = 2e-06 (/millisecond): a kinetic parameter
	kr_R26 = 3.3e-07 (/millisecond): a kinetic parameter
	kf_R27 = 0.0002 (/millisecond): a kinetic parameter
	kf_R28 = 0.00049998 (liter/micromole-millisecond): a kinetic parameter
	kr_R28 = 0.0001 (/millisecond): a kinetic parameter
	kf_R29 = 2.50002e-05 (liter/micromole-millisecond): a kinetic parameter
	kr_R29 = 1.68e-05 (/millisecond): a kinetic parameter
	kf_R30 = 1e-06 (/millisecond): a kinetic parameter
	kf_R31 = 2.50002e-05 (liter/micromole-millisecond): a kinetic parameter
	kr_R31 = 1.68e-05 (/millisecond): a kinetic parameter
	kf_R32 = 0.000999997 (liter/micromole-millisecond): a kinetic parameter
	kr_R32 = 0.001 (/millisecond): a kinetic parameter
	kf_R33 = 0.179998 (liter/micromole-millisecond): a kinetic parameter
	kr_R33 = 0.01 (/millisecond): a kinetic parameter
	kf_R34 = 0.0120001 (liter/micromole-millisecond): a kinetic parameter
	kr_R34 = 0.01 (/millisecond): a kinetic parameter
	kf_R35 = 5e-05 (/millisecond): a kinetic parameter
	kf_R36 = 7e-05 (/millisecond): a kinetic parameter
	kf_R37 = 0.000949784 (liter/micromole-millisecond): a kinetic parameter
	kr_R37 = 0.016 (/millisecond): a kinetic parameter
	kf_R38 = 0.004 (/millisecond): a kinetic parameter
	kf_R39 = 0.00565656 (liter/micromole-millisecond): a kinetic parameter
	kr_R39 = 0.016 (/millisecond): a kinetic parameter
	kf_R40 = 0.004 (/millisecond): a kinetic parameter
	kf_R41 = 0.00565656 (liter/micromole-millisecond): a kinetic parameter
	kr_R41 = 0.016 (/millisecond): a kinetic parameter
	kf_R42 = 0.004 (/millisecond): a kinetic parameter
	kf_R43 = 0.00127273 (liter/micromole-millisecond): a kinetic parameter
	kr_R43 = 0.0216 (/millisecond): a kinetic parameter
	kf_R44 = 0.0054 (/millisecond): a kinetic parameter
	kf_R45 = 0.00260202 (liter/micromole-millisecond): a kinetic parameter
	kr_R45 = 0.04416 (/millisecond): a kinetic parameter
	kf_R46 = 0.01104 (/millisecond): a kinetic parameter
	kf_R47 = 0.00848484 (liter/micromole-millisecond): a kinetic parameter
	kr_R47 = 0.144 (/millisecond): a kinetic parameter
	kf_R48 = 0.036 (/millisecond): a kinetic parameter
	kf_R49 = 0.0141414 (liter/micromole-millisecond): a kinetic parameter
	kr_R49 = 0.24 (/millisecond): a kinetic parameter
	kf_R50 = 0.06 (/millisecond): a kinetic parameter
	kf_R51 = 0.0282828 (liter/micromole-millisecond): a kinetic parameter
	kr_R51 = 0.48 (/millisecond): a kinetic parameter
	kf_R52 = 0.12 (/millisecond): a kinetic parameter
	kf_R53 = 0.00237576 (liter/micromole-millisecond): a kinetic parameter
	kr_R53 = 0.04 (/millisecond): a kinetic parameter
	kf_R54 = 0.01 (/millisecond): a kinetic parameter
	kf_R55 = 0.0452525 (liter/micromole-millisecond): a kinetic parameter
	kr_R55 = 0.192 (/millisecond): a kinetic parameter
	kf_R56 = 0.048 (/millisecond): a kinetic parameter
	kf_R57 = 0.00367676 (liter/micromole-millisecond): a kinetic parameter
	kr_R57 = 0.08 (/millisecond): a kinetic parameter
	kf_R58 = 0.02 (/millisecond): a kinetic parameter
	kf_R59 = 0.00021477 (liter/micromole-millisecond): a kinetic parameter
	kr_R59 = 0.393237 (/millisecond): a kinetic parameter
	kf_R60 = 0.00663197 (/millisecond): a kinetic parameter
	kf_R61 = 0.0183838 (liter/micromole-millisecond): a kinetic parameter
	kr_R61 = 0.04 (/millisecond): a kinetic parameter
	kf_R62 = 0.01 (/millisecond): a kinetic parameter
	kf_R63 = 0.00152766 (liter/micromole-millisecond): a kinetic parameter
	kr_R63 = 7.47446e-05 (/millisecond): a kinetic parameter
	kf_R64 = 0.0014482 (/millisecond): a kinetic parameter
	kf_R65 = 0.032383 (liter/micromole-millisecond): a kinetic parameter
	kr_R65 = 0.00552525 (/millisecond): a kinetic parameter
	kf_R66 = 0.0014552 (/millisecond): a kinetic parameter
	kf_R67 = 0.0091477 (liter/micromole-millisecond): a kinetic parameter
	kr_R67 = 0.000563956 (/millisecond): a kinetic parameter
	kf_R68 = 0.00257271 (/millisecond): a kinetic parameter
	kf_R69 = 0.0815603 (liter/micromole-millisecond): a kinetic parameter
	kr_R69 = 0.000501669 (/millisecond): a kinetic parameter
	kf_R70 = 0.00296098 (/millisecond): a kinetic parameter
	kf_R71 = 9.35627e-05 (liter/micromole-millisecond): a kinetic parameter
	kr_R71 = 1.65789e-05 (/millisecond): a kinetic parameter
	kf_R72 = 2.4999e-06 (/millisecond): a kinetic parameter
	kf_R73 = 9.10925e-05 (liter/micromole-millisecond): a kinetic parameter
	kr_R73 = 0.000763615 (/millisecond): a kinetic parameter
	kf_R74 = 2.41732e-06 (/millisecond): a kinetic parameter
	kf_R75 = 0.0555721 (liter/micromole-millisecond): a kinetic parameter
	kr_R75 = 0.00400166 (/millisecond): a kinetic parameter
	kf_R76 = 0.0998178 (/millisecond): a kinetic parameter
	kf_R77 = 0.00186667 (liter/micromole-millisecond): a kinetic parameter
	kr_R77 = 0.0008 (/millisecond): a kinetic parameter
	kf_R78 = 0.0002 (/millisecond): a kinetic parameter
	kf_R79 = 0.00282828 (liter/micromole-millisecond): a kinetic parameter
	kr_R79 = 0.0008 (/millisecond): a kinetic parameter
	kf_R80 = 0.0002 (/millisecond): a kinetic parameter
	kf_R81 = 0.00113131 (liter/micromole-millisecond): a kinetic parameter
	kr_R81 = 0.0008 (/millisecond): a kinetic parameter
	kf_R82 = 0.0002 (/millisecond): a kinetic parameter
	kf_R83 = 0.00186667 (liter/micromole-millisecond): a kinetic parameter
	kr_R83 = 0.0008 (/millisecond): a kinetic parameter
	kf_R84 = 0.0002 (/millisecond): a kinetic parameter
	kf_R85 = 0.014 (/millisecond): a kinetic parameter
	kr_R85 = 97.2215 (micromole/liter): a kinetic parameter
	kf_R86 = 0.057 (/millisecond): a kinetic parameter
	kr_R86 = 19.7915 (micromole/liter): a kinetic parameter
	kf_R87 = 0.00797312 (liter/micromole-millisecond): a kinetic parameter
	kr_R87 = 0.002 (/millisecond): a kinetic parameter
	kf_R88 = 0.0005 (/millisecond): a kinetic parameter
	kf_R89 = 0.00271478 (liter/micromole-millisecond): a kinetic parameter
	kr_R89 = 0.016 (/millisecond): a kinetic parameter
	kf_R90 = 0.004 (/millisecond): a kinetic parameter
	kf_R91 = 0.00271478 (liter/micromole-millisecond): a kinetic parameter
	kr_R91 = 0.016 (/millisecond): a kinetic parameter
	kf_R92 = 0.004 (/millisecond): a kinetic parameter
	kf_R93 = 0.00186667 (liter/micromole-millisecond): a kinetic parameter
	kr_R93 = 0.025 (/millisecond): a kinetic parameter
	kf_R94 = 0.006 (/millisecond): a kinetic parameter
	kf_R95 = 0.00186667 (liter/micromole-millisecond): a kinetic parameter
	kr_R95 = 0.025 (/millisecond): a kinetic parameter
	kf_R96 = 0.006 (/millisecond): a kinetic parameter
	kf_R97 = 0.00186667 (liter/micromole-millisecond): a kinetic parameter
	kr_R97 = 0.025 (/millisecond): a kinetic parameter
	kf_R98 = 0.006 (/millisecond): a kinetic parameter
	kf_R99 = 0.00186667 (liter/micromole-millisecond): a kinetic parameter
	kr_R99 = 0.025 (/millisecond): a kinetic parameter
	kf_R100 = 0.006 (/millisecond): a kinetic parameter
	kf_R101 = 0.00180646 (liter/micromole-millisecond): a kinetic parameter
	kr_R101 = 0.024 (/millisecond): a kinetic parameter
	kf_R102 = 0.006 (/millisecond): a kinetic parameter
	PPhosphatase2A_ConservedConst = 0.260008 : the total amount of a conserved sub-set of states
	MKP_1_ConservedConst = 0.02 : the total amount of a conserved sub-set of states
	PLCg_basal_ConservedConst = 0.000700024 : the total amount of a conserved sub-set of states
	PLC_g_ConservedConst = 0.820008 : the total amount of a conserved sub-set of states
	Grb2_ConservedConst = 0.9 : the total amount of a conserved sub-set of states
	SHC_ConservedConst = 0.400008 : the total amount of a conserved sub-set of states
	Sos_ConservedConst = 0.1 : the total amount of a conserved sub-set of states
	EGFR_ConservedConst = 0.166664 : the total amount of a conserved sub-set of states
	CaM_GEF_ConservedConst = 0 : the total amount of a conserved sub-set of states
	GAP_ConservedConst = 0.02 : the total amount of a conserved sub-set of states
	inact_GEF_ConservedConst = 0.1 : the total amount of a conserved sub-set of states
	GDP_Ras_ConservedConst = 0.5 : the total amount of a conserved sub-set of states
	MAPKK_ConservedConst = 0.180008 : the total amount of a conserved sub-set of states
	craf_1_ConservedConst = -0.3 : the total amount of a conserved sub-set of states
	MAPK_ConservedConst = 0.36 : the total amount of a conserved sub-set of states
	PLC_Ca_Gq_ConservedConst = 0 : the total amount of a conserved sub-set of states
	PLC_ConservedConst = 0.8 : the total amount of a conserved sub-set of states
	...
	PLA2_cytosolic_ConservedConst = 0.4 : the total amount of a conserved sub-set of states
	PKC_cytosolic_ConservedConst = 1.02 : the total amount of a conserved sub-set of states
}
ASSIGNED {
...
PROCEDURE assign_calculated_values() {
	...
	APC = 30.0007914522125 : assignment for expression S17
	Inositol = 0 : assignment for expression S22
	PC = 0 : assignment for expression S26
	PIP2 = 6.99999999999054 : assignment for expression S29
			
	EGF = EGF_level/(1+exp(-(t-EGF_start)*EGF_steepness))

	Ca = 0.0799999999999369 : assignment for expression S69
...
STATE {
	PKC_Ca (micromole/liter) : a state variable
	PKC_DAG_AA_p (micromole/liter) : a state variable
	PKC_Ca_AA_p (micromole/liter) : a state variable
	PKC_Ca_memb_p (micromole/liter) : a state variable
	PKC_DAG_memb_p (micromole/liter) : a state variable
	PKC_basal_p (micromole/liter) : a state variable
	PKC_AA_p (micromole/liter) : a state variable
	PKC_Ca_DAG (micromole/liter) : a state variable
	PKC_DAG (micromole/liter) : a state variable
	PKC_DAG_AA (micromole/liter) : a state variable
	: PKC_cytosolic is calculated via Conservation Law
	: PLA2_cytosolic is calculated via Conservation Law
	PLA2_Ca_p (micromole/liter) : a state variable
	: PIP2_PLA2_p is calculated via Conservation Law
	: PIP2_Ca_PLA2_p is calculated via Conservation Law
	DAG_Ca_PLA2_p (micromole/liter) : a state variable
	PLA2_p_Ca (micromole/liter) : a state variable
	PLA2_p (micromole/liter) : a state variable
	Arachidonic_Acid (micromole/liter) : a state variable
	: PLC is calculated via Conservation Law
	PLC_Ca (micromole/liter) : a state variable
	: PLC_Ca_Gq is calculated via Conservation Law
	PLC_Gq (micromole/liter) : a state variable
	DAG (micromole/liter) : a state variable
	IP3 (micromole/liter) : a state variable
	MAPK_p_p (micromole/liter) : a state variable
	: craf_1 is calculated via Conservation Law
	craf_1_p (micromole/liter) : a state variable
	: MAPKK is calculated via Conservation Law
	: MAPK is calculated via Conservation Law
	craf_1_p_p (micromole/liter) : a state variable
	MAPK_p (micromole/liter) : a state variable
	MAPKK_p_p (micromole/liter) : a state variable
	MAPKK_p (micromole/liter) : a state variable
	Raf_p_GTP_Ras (micromole/liter) : a state variable
	craf_1_p_ser259 (micromole/liter) : a state variable
	: inact_GEF is calculated via Conservation Law
	GEF_p (micromole/liter) : a state variable
	GTP_Ras (micromole/liter) : a state variable
	: GDP_Ras is calculated via Conservation Law
	GAP_p (micromole/liter) : a state variable
	: GAP is calculated via Conservation Law
	inact_GEF_p (micromole/liter) : a state variable
	: CaM_GEF is calculated via Conservation Law
	: EGFR is calculated via Conservation Law
	L_EGFR (micromole/liter) : a state variable
	Internal_L_EGFR (micromole/liter) : a state variable
	SHC_p_Sos_Grb2 (micromole/liter) : a state variable
	: SHC is calculated via Conservation Law
	SHC_p (micromole/liter) : a state variable
	Sos_p_Grb2 (micromole/liter) : a state variable
	: Grb2 is calculated via Conservation Law
	Sos_Grb2 (micromole/liter) : a state variable
	Sos_p (micromole/liter) : a state variable
	: Sos is calculated via Conservation Law
	SHC_p_Grb2_clx (micromole/liter) : a state variable
	: PLC_g is calculated via Conservation Law
	PLC_g_p (micromole/liter) : a state variable
	Ca_PLC_g (micromole/liter) : a state variable
	Ca_PLC_g_p (micromole/liter) : a state variable
	...
	PKC_act_raf_cplx (micromole/liter) : a state variable
	PKC_inact_GAP_cplx (micromole/liter) : a state variable
	PKC_act_GEF_cplx (micromole/liter) : a state variable
	kenz_cplx (micromole/liter) : a state variable
	kenz_cplx_1 (micromole/liter) : a state variable
	kenz_cplx_2 (micromole/liter) : a state variable
	kenz_cplx_3 (micromole/liter) : a state variable
	kenz_cplx_4 (micromole/liter) : a state variable
	PLC_Ca_cplx (micromole/liter) : a state variable
	PLCb_Ca_Gq_cplx (micromole/liter) : a state variable
	MAPK_p_p_cplx (micromole/liter) : a state variable
	MAPK_p_p_feedback_cplx (micromole/liter) : a state variable
	phosph_Sos_cplx (micromole/liter) : a state variable
	MAPKKtyr_cplx (micromole/liter) : a state variable
	MAPKKthr_cplx (micromole/liter) : a state variable
	Raf_p_GTP_Ras_1_cplx (micromole/liter) : a state variable
	Raf_p_GTP_Ras_2_cplx (micromole/liter) : a state variable
	basal_GEF_activity_cplx (micromole/liter) : a state variable
	GEF_p_act_Ras_cplx (micromole/liter) : a state variable
	GAP_inact_Ras_cplx (micromole/liter) : a state variable
	CaM_GEF_act_Ras_cplx (micromole/liter) : a state variable
	Ca_PLC_g_phospho_cplx (micromole/liter) : a state variable
	SHC_phospho_cplx (micromole/liter) : a state variable
	Sos_Ras_GEF_cplx (micromole/liter) : a state variable
	PLC_g_phospho_cplx (micromole/liter) : a state variable
	MKP1_tyr_deph_cplx (micromole/liter) : a state variable
	MKP1_thr_deph_cplx (micromole/liter) : a state variable
	craf_dephospho_cplx (micromole/liter) : a state variable
	MAPKK_dephospho_cplx (micromole/liter) : a state variable
	MAPKK_dephospho_ser_cplx (micromole/liter) : a state variable
	craf_p_p_dephospho_cplx (micromole/liter) : a state variable
	deph_raf_ser259_cplx (micromole/liter) : a state variable
}
INITIAL {
	 ...
	 PKC_basal_p = 0.0200000000000631 : initial condition
	...
	: PLC_Ca_Gq cannot have initial values as it is determined by conservation law
	 ...
	 IP3 = 0.730003957260999 : initial condition
...
DERIVATIVE ode {
	...
	: Compound PKC_cytosolic with ID S10 and initial condition 1 had derivative -ReactionFlux0-ReactionFlux6-ReactionFlux7-ReactionFlux8, but is calculated by conservation law.
	: Compound PLA2_cytosolic with ID S12 and initial condition 0.4 had derivative -ReactionFlux10+ReactionFlux14-ReactionFlux56, but is calculated by conservation law.
	...
	: Compound PLC with ID S21 and initial condition 0.8 had derivative -ReactionFlux15, but is calculated by conservation law.
	...
	: Compound craf_1 with ID S31 and initial condition 0.2 had derivative -ReactionFlux36+ReactionFlux93+ReactionFlux101, but is calculated by conservation law.
	craf_1_p' = -ReactionFlux19+ReactionFlux37-ReactionFlux58-ReactionFlux92+ReactionFlux99 : affects compound with ID S32
	: Compound MAPKK with ID S33 and initial condition 0.180008 had derivative -ReactionFlux66+ReactionFlux97, but is calculated by conservation law.
	: Compound MAPK with ID S34 and initial condition 0.36 had derivative -ReactionFlux62+ReactionFlux89, but is calculated by conservation law.
	...
	: Compound inact_GEF with ID S41 and initial condition 0.1 had derivative +ReactionFlux20+ReactionFlux23-ReactionFlux40-ReactionFlux70+ReactionFlux71, but is calculated by conservation law.
	...
	: Compound GDP_Ras with ID S44 and initial condition 0.5 had derivative +ReactionFlux21-ReactionFlux70-ReactionFlux72+ReactionFlux75-ReactionFlux76-ReactionFlux82, but is calculated by conservation law.
	GAP_p' = -ReactionFlux22+ReactionFlux39 : affects compound with ID S45
	: Compound GAP with ID S46 and initial condition 0.02 had derivative +ReactionFlux22-ReactionFlux38-ReactionFlux74+ReactionFlux75, but is calculated by conservation law.
	...
	: Compound EGFR with ID S49 and initial condition 0.166664 had derivative -ReactionFlux24, but is calculated by conservation law.
	...
	: Compound SHC with ID S54 and initial condition 0.500008 had derivative +ReactionFlux26-ReactionFlux80, but is calculated by conservation law.
	...
	: Compound Grb2 with ID S57 and initial condition 1 had derivative -ReactionFlux28-ReactionFlux30-ReactionFlux31, but is calculated by conservation law.
	...
	: Compound Sos with ID S60 and initial condition 0.1 had derivative +ReactionFlux29-ReactionFlux30-ReactionFlux60, but is calculated by conservation law.
	SHC_p_Grb2_clx' = ReactionFlux31 : affects compound with ID S61
	: Compound PLC_g with ID S62 and initial condition 0.820008 had derivative -ReactionFlux32+ReactionFlux35-ReactionFlux86, but is calculated by conservation law.
	...
	: Compound PLCg_basal with ID S66 and initial condition 0.000700024 had derivative -ReactionFlux86+ReactionFlux87, but is calculated by conservation law.
	: Compound MKP_1 with ID S67 and initial condition 0.02 had derivative -ReactionFlux88+ReactionFlux89-ReactionFlux90+ReactionFlux91, but is calculated by conservation law.
	: Compound PPhosphatase2A with ID S68 and initial condition 0.260008 had derivative -ReactionFlux92+ReactionFlux93-ReactionFlux94+ReactionFlux95-ReactionFlux96+ReactionFlux97-ReactionFlux98+ReactionFlux99-ReactionFlux100+ReactionFlux101, but is calculated by conservation law.
...
PROCEDURE observables_func() {
	pERK1_2_ratio1 = (MAPK_p+MAPK_p_p) : Output ID Y0
	pERK1_2_ratio2 = (MAPK_p+MAPK_p_p) : Output ID Y1
}
