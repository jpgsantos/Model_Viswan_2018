...
#h('MAPK_P = 0.0')
#h('MAPK_P_P = 0.0')
cell.somalist[0].insert('Viswan_2018')
cell.somalist[0].EGF_start_Viswan_2018 = p.EGF_input_start
cell.somalist[0].EGF_length_Viswan_2018 = p.EGF_input_length
cell.somalist[0].EGF_level_Viswan_2018 = p.EGF_level
cell.somalist[0].EGF_steepness_Viswan_2018 = p.EGF_steepness
...
#            h.setpointer(cell.somalist[0](0.5)._ref_MAPK_p_Viswan_2018, 'MAPK_P', seg.kaf)
#            h.setpointer(cell.somalist[0](0.5)._ref_MAPK_p_p_Viswan_2018, 'MAPK_P_P', seg.kaf)
#            h.setpointer(h._ref_MAPK_P, 'MAPK_P', seg.kaf)
#            h.setpointer(h._ref_MAPK_P, 'MAPK_P_P', seg.kaf)
#
#
#gkaf = h.Vector()
...
ex = pe.EGF_Experiment('record_ca', cell)           
